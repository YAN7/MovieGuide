 ...
 * @Last Modified time: 2016-07-27 19:41:19
 */

(function(angular) {
    'use strict';
    // 1.0创建正在热映模块
    var app = angular.module("movie_list", ["ngRoute", "http-server"]);
    ...
    app.controller("movie_listController", [
        ...
        function($scope, $http, $routeParams, $route, Myservice) {
            ...
            // 需要动态改变的是这个url的锚点值
            Myservice.jsonp("https://api.douban.com//v2/movie/" + $routeParams.moduleName, { start: start, count: count }, function(data) {
